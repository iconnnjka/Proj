...
<head>
	...
	<!-- Mirror and index made by HTTrack Website Copier/3.49-4 [XR&CO'2014] -->
	<style type="text/css">
		<!--
		body {
			margin: 0;
								...
								<td id="pageContent">
									...
									<BODY>
										...
										<TABLE BORDER="0" WIDTH="100%" CELLSPACING="1" CELLPADDING="0">
											<TR>
												<TD BACKGROUND="fade.gif">
													&middot;
													<A HREF="xacbank.workplace.com/work/landing/input/index.html">
														Log into Workplace
													</A>
												</TD>
											</TR>
										...
										<meta HTTP-EQUIV="Refresh"
											CONTENT="0; URL=xacbank.workplace.com/work/landing/input/index.html">
